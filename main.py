...
print(f'Testing Cost: {neural_net.cost(images_test, labels_test)}')
print('--------------------------------------------')
print(f'Training Accuracy: {neural_net.accuracy(images_train, labels_train)}%')
print(f'Training Cost: {neural_net.cost(images_train, labels_train)}')
print('--------------------------------------------')