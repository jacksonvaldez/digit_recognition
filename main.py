...
print('--------------------------------------------')
print(f'Testing Accuracy: {neural_net.compute_accuracy(images_test, labels_test)}%')
print(f'Testing Cost: {neural_net.compute_cost(images_test, labels_test)}')
print('--------------------------------------------')
print(f'Training Accuracy: {neural_net.compute_accuracy(images_train, labels_train)}%')
print(f'Training Cost: {neural_net.compute_cost(images_train, labels_train)}')
print('--------------------------------------------')