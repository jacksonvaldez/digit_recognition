...
weights1 = np.random.uniform(-0.05, 0.05, (160, 784)) # Weights connecting the input layer and the hidden layer (160 x 784)
weights2 = np.random.uniform(-0.05, 0.05, (10, 160)) # Weights connecting the hidden layer and the output layer (10 x 160)

# Creates a set of biases, all 0 to start
biases1 = np.full(160, 0, dtype=np.float64).reshape(160, 1) # Biases connecting the input layer and the hidden layer (160 x 1)
